...
#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "5902286751"))

#Port
PORT = os.environ.get("PORT", "8080")

#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://sonu999:sonu999@cluster0.ehmf7cn.mongodb.net/?retryWrites=true&w=majority")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "778393824").split()):
        ADMINS.append(int(x))
except ValueError:
